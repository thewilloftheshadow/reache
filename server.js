...
const config = require("/home/sd/utopium/wwou/util/config.js"),
  fn = require("/home/sd/utopium/wwou/util/fn.js"),
  tags = require("/home/sd/utopium/wwou/util/tags.js")

const games = new db.table("Games"),
  players = new db.table("Players"),
  nicknames = require("/home/sd/utopium/global/db.js").nicknames,
  authdb = require("/home/sd/utopium/global/db.js").authdb,
  apidb = new db.table("api")

const roles = require("/home/sd/utopium/wwou/util/roles.js")
...
// map({
//   sitemap: "/home/sd/utopium/wwou/public/sitemap.xml",
//   robots: "/home/sd/utopium/wwou/public/robots.txt",
//   generate: app,
...
module.exports = client => {
  client.on("ready", async () => {
    ...
    app.get("/json.sqlite", checkAuth, devonly, async (req, res) => {
      res.sendFile("/home/sd/utopium/wwou/json.sqlite")
    })

    // app.get("/oldlog/:id", checkAuth, viewLogs, async (req, res) => {
    //   //if (!req.user.viewLogs) return res.redirect("/")
    //   let file = "/home/sd/utopium/wwou/logs/" + req.params.id + ".log"
    ...
    app.get("/logs", checkAuth, viewLogs, async (req, res) => {
      ...
      let files = fs.readdirSync("/home/sd/utopium/wwou/logs")
      files = files.filter(
    ...
    app.get("/log/:id", checkAuth, viewLogs, async (req, res) => {
      ...
      let fulllog = fs.readFileSync(`/home/sd/utopium/wwou/logs/${file}`, "utf8")
      // console.log(fulllog)
    ...
    app.get("/devlogs", checkAuth, viewLogs, async (req, res) => {
      ...
      let files = fs.readdirSync("/home/sd/.pm2/logs")
      files = files.filter(
        f => f.toLowerCase().endsWith(".log")
      )
      pass.files = files
    ...
    app.get("/devlog/:id", checkAuth, viewLogs, async (req, res) => {
      ...
      let fulllog = fs.readFileSync(`/home/sd/.pm2/logs/${file}`, "utf8")
      // console.log(fulllog)
      let logs = fulllog.split("\n")
